...
from dubbing.transcription.transcriber import make_transcription_handler
...
# Step 6 doirasida ishlaydigan bosqichlar. Keyingi bosqichlar (diarization,
# translation, ...) o'z handlerlari yozilganda shu ro'yxatga qo'shiladi.
STAGES = ["ingestion", "segmentation", "transcription"]
...
async def _async_main() -> None:
    ...
    worker.register_handler("transcription", make_transcription_handler(pool))
